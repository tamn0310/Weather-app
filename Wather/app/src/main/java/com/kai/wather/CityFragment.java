    ...
    private class LoadCities extends SimpleAsyncTask<List<String>> {
        ...
        protected List<String> doInBackgroundSimple() {
            ...
            try{
                ...
                InputStreamReader render = new InputStreamReader(gzipInputStream);
                BufferedReader in = new BufferedReader(render);

                String readed;
                while((readed = in.readLine())!=null)
                    buider.append(readed);
                lstCities = new Gson().fromJson(buider.toString(),new TypeToken<List<String>>(){}.getType());
